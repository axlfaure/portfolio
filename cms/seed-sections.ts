...
const SECTIONS: { slug: string; data: Record<string, unknown> }[] = [
  ...
  },
  {
    ...
    data: {
      ...
      lead: "Selon que le besoin revienne ou non, on ne s'organise pas de la même façon.",
      offers: [
        {
          icon: "doc",
          name: "One shot",
          tagline: "Un besoin isolé, sans suite.",
          pricePrefix: "à partir de",
          price: "500 €",
          priceSuffix: "/ jour",
          priceUnit: "en prestation ponctuelle",
          trend: "Sans engagement",
          trendUp: false,
          ctaLabel: "Chiffrer un besoin",
          highlight: false,
          items: [
            { label: "Un seul interlocuteur" },
            { label: "Devis à prix ferme" },
            { label: "Deux allers-retours inclus" },
            { label: "Fichiers sources livrés" },
            { label: "Livré en deux semaines" },
          ],
        },
        {
          icon: "exchange",
          name: "Partner",
          badge: "Recommandée",
          tagline: "Des besoins qui reviennent.",
          pricePrefix: "à partir de",
          price: "400 €",
          priceSuffix: "/ jour",
          ...
          items: [
            ...
            { label: "Une commande par an" },
            { label: "Grille tarifaire figée" },
            {
              label: "Livré sous 5 jours",
              note: "Tant que le périmètre convenu le permet.",
            },
            { label: "Supports automatisés" },
          ],
        },
        {
          icon: "layers",
          name: "Custom",
          tagline: "Un projet hors catalogue.",
          pricePrefix: "budget",
          price: "Sur devis",
          priceUnit: "défini ensemble",
          trend: "Périmètre libre",
          trendUp: false,
          ctaLabel: "En parler",
          highlight: false,
          items: [
            { label: "Tout One shot" },
            { label: "Outil métier sur mesure" },
            { label: "Dispositif de salon" },
            { label: "Production photo et vidéo" },
            { label: "Devis ligne à ligne" },
          ],
        },
      ],
      footnote:
