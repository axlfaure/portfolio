      ...
      offers: [
        {
          icon: "doc",
          name: "One shot",
          tagline: "Un besoin isolé, sans suite prévue.",
        ...
        },
        {
          ...
          name: "Partner",
          badge: "Recommandée",
          tagline: "Des besoins qui reviennent toute l'année.",
          pricePrefix: "à partir de",
          price: "240 €",
          priceUnit: "la même prestation",
          trend: "20 % moins cher",
          ctaLabel: "Voir si Partner convient",
          highlight: true,
          items: [
            { label: "Tout One shot" },
            { label: "Une seule commande par an" },
            { label: "Grille figée douze mois" },
            { label: "Délais compensés" },
            { label: "Supports automatisés" },
            { label: "Quatre clients par an" },
          ],
        },
        {
          icon: "layers",
          ...
          price: "Sur devis",
          priceUnit: "périmètre défini ensemble",
          ctaLabel: "En parler",
          highlight: false,
          items: [
            { label: "Tout One shot" },
            { label: "Outil métier sur mesure" },
            { label: "Dispositif de salon complet" },
            { label: "Production photo et vidéo" },
            { label: "Périmètre défini ensemble" },
          ],
        },
      ],
      footnote:
